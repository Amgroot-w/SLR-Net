...
if __name__ == "__main__":
    ...
    model_id = TIMESTAMP + net_name + '_' + dataset_name + str(acc) + '_epoch_50' + '_lr_' + str(
        learning_rate) + '_ocmr_fine_tuning'
    ...
    for epoch in range(num_epoch):
        for step, sample in enumerate(dataset):
            ...
            # log output
            tf.print('Epoch', epoch + 1, '/', num_epoch, 'Step', step, 'loss =', loss_mse.numpy(), 'time',
