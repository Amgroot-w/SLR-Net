...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight', metavar='str', nargs=1, default=[
        'models/stable/2020-11-05T19-31-19SLRNET_OCMR8_epoch_50_lr_0.0001_ocmr_fine_tuning/epoch-50/ckpt'],
                        help='modeldir in ./models')
